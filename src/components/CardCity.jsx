    ...
    return (
      <div className="group col-6">
        <Anchor to={'/city/'+id} className="flex p-2 m-2">
          ...
          <p className="absolute flex bg-gradient-to-r from-gray-600 mt-2 p-1 justify-start tracking-wider hidden sm:flex text-xs font-bold bg-opacity-60 text-white ps-2 uppercase">{text}</p>
