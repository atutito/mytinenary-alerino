...
export default function header() {
  ...
  return (
    <div className='flex flex-col md:flex-row lg:flex md:justify-between border-b-2 pb-2'>
      ...
      {show ? (
        <>
      <div className='flex flex-col items-start md:flex-row ms-5 top-10 left-2 self-center align-middle'>
      ...
      <Anchor to={'/Cities'}>
      <div className="flex mt-1 px-2 align-middle font-medium text-center text-white hover:text-black font-bold rounded-lg bg-indigo-600 hover:bg-[#5a4b03] hover:invert cursor-pointer hover:translate-y-1 duration-100">
