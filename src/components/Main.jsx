  ...
  return (
    <div className="flex h-screen items-center">
          <div className="text-left mr-auto lg:col-span-7">
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-purple-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">View More</a>
          </div>
          <Carousel />
    </div>  
)
