  ...
  return (
    <div className="flex-col-reverse grow sm:flex md:flex lg:flex-row pt-3 items-center gap-3">
          <div className="text-center">
            <h1 className="max-w-xl mb-4 text-xl font-bold tracking-widest leading-none md:text-2xl xl:text-3xl dark:text-white ">Find the perfect destination</h1>
            ...
            <Anchor to={'/Cities'} className="inline-flex px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-indigo-600 hover:bg-[#5a4b03] hover:invert cursor-pointer hover:translate-y-1 duration-100">View More</Anchor>
          </div>
          <Carousel />
    </div>   
)
